...
import com.example.storyapp_ade.DataDummy
import com.example.storyapp_ade.MainDispatcherRule
...
import com.example.storyapp_ade.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.story()).thenReturn(expectedStory)
